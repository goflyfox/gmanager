...
type MenuListRes struct {
	List []*input.MenuTreeRes `json:"list" dc:"菜单列表"`
	input.PageRes
}
...
type MenuOptionsRes = []*input.OptionVal
...
type MenuSaveReq struct {
	...
	ParamList  []*input.KeyValue `json:"paramList"  description:"路由参数列表"`
