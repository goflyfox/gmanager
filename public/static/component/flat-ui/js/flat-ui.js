...
/* ========================================================================
 * Bootstrap: transition.js2 v3.2.0
...
+function ($) {
  ...
  Popover.prototype.setContent = function () {
    ...
    $tip.find('.popover-content').empty()[ // we use append for html objects to maintain js2 events
...
/* ========================================================================
 * Bootstrap: scrollspy.js2 v3.2.0
...
(function ($) {
  ...
  TagsInput.prototype = {
     ...
     * is normally the $container, but typeahead.js2 moves the $input element.
     */
