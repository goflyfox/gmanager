...
INSERT INTO sys_config (id, name, `key`, value, code, data_type, parent_id, parent_key, remark, sort, copy_status, change_status, enable, update_at, update_id, create_at, create_id) VALUES (55, '是否启动验证码', 'system.captchaEnabled', 'false', '', 3, 24, 'system', '', 11, 0, 0, 1, '2026-05-07 05:33:04', 1, '2026-05-07 05:33:04', 1);
